            ...
            <div className="flex justify-center items-center">
                <div className="flex justify-between flex-col lg:flex-row gap-10 lg:gap-0 lg:w-[85vw] w-full px-4 lg:px-0 py-14 items-center">
                    <div className="lg:w-1/2 w-full space-y-9">
                        <div>
                            <h1 className='text-[#CFA670] font-bold text-5xl'>About Us</h1>
                            <h3 className="text-black font-semibold mt-4 text-2xl">QUALITY OF RESTURANT</h3>
                        </div>
                    ...
                    <div className='lg:w-[37vw] w-full h-96 rounded-md relative overflow-hidden'>
                        <img src='https://www.barfithefoodmagician.co.in/sitepad-data/uploads/2024/05/aboutus01.jpg' className='w-full h-full object-cover transition-transform duration-500 hover:scale-110' />
                    </div>
                </div>
            </div>
            {/* bg image */}
            <div className="relative py-6 w-full h-[85vh] about-bg-fixed">
                <div className="relative py-6 w-full h-[85vh] about-bg-fixed flex items-center justify-center lg:justify-end lg:px-28">
                    <div className="bg-white lg:p-8 py-6 px-4 rounded-lg flex flex-col justify-center items-center shadow-lg max-w-lg w-[88vw] lg:w-full">
                        <h3 className="lg:text-3xl text-2xl font-semibold text-[#CFA670] mb-2 text-center">GuestBook</h3>
                        <h4 className="text-lg font-bold mb-4 text-center">Client Testimonial</h4>
                        <img src="https://www.barfithefoodmagician.co.in/sitepad-data/uploads/2024/05/logo.png" className="w-12 h-12" />
                        <p className="text-center mt-6 mb-6">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
                        </p>
                        <div className="flex items-center justify-center">
                            <img src="https://www.barfithefoodmagician.co.in/sitepad-data/uploads/2024/05/clients01.jpg" alt="Client Photo" className="w-20 h-20 rounded-full mb-5" />
                        </div>
